...
__global__ void Dist(float* Od, float* OH, float* mol, int* NOd, int* NOH, float* Lx, float* Ly, float* rcut2D, float* dz, int* nbin, float* Dens_Od, float* Dens_OH, int* Odval) 
{
